        ...
        <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    <table style="width: 100%;">
                            ...
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="float: right; background-color:#C7DB5E; color: black;"><b><span id="lbresult"></span></b></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:GridView ID="grdquestions" runat="server" AutoGenerateColumns="false" OnRowDataBound="grdquestions_RowDataBound" DataKeyNames="QuestionId" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" BackColor="#C7DB5E">
                                    <AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                                    <Columns>
                                        <asp:TemplateField HeaderText="Communication System For Deaf and Dumb Quiz Evaluation">
                                            <ItemTemplate>
                                                <table class="tableclass" id='<%#Eval("QuestionId") %>'>
                                                    <tr>
                                                        <td>Question <%#Eval("QuestionId") %><br/> <img src="<%#Eval("Question") %>"style="margin-left:50%;margin-right:50%;" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <table class="tblOptions" style="font-size:large;font-weight:bolder;">
                                                                            <tr>
                                                                                <td>
                                    ...
                                    <RowStyle BackColor="#C7DB5E"></RowStyle>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn" OnClientClick="return CheckIfAllQuestionAnswerHasBeenSubmitted()" Height="53px" Width="243px" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
    ...
    <script>
        ...
        function CheckIfAllQuestionAnswerHasBeenSubmitted() {
            ...
            if (parseInt(flagtocheckcount) == parseInt(numItems)) {
                ...
                $("#lbresult").text("Final Result-:" + CountFinalResult + "/10");
